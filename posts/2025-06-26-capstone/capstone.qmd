...
In addition to the z-score, the calculation generates a [p-value](https://pro.arcgis.com/en/pro-app/latest/tool-reference/spatial-statistics/what-is-a-z-score-what-is-a-p-value.htm) that is interpreted into hot spots or cold spots. The p-values here are slightly different because they are interpreted with a positive or negative sign. The direction is important to note whether an area is significantly hot, or significantly cold.
